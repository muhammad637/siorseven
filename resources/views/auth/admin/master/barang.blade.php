                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0" id="myTable">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tipe Barang</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jenis Barang</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Merk Barang
                                    </th>
                                    <th
                                ...
                                @foreach ($barangs as $barang)
                                    <tr>
                                        ...
                                        <td class="align-middle text-end">
                                            <div class="d-flex px-3 py-1 justify-content-center align-items-center gap-1">
                                                <a href="#modaledit-{{ $barang->id}}" data-bs-toggle="modal" class="badge bg-warning">edit</a>
                                                <a href="" class="badge bg-success ">aktif</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="modaledit-{{ $barang->id}}" tabindex="-1" role="dialog" aria-labelledby="modaledittbarang"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('update.barang' , ['barang' => $barang->id])}}" method="post" >
                                                @method('put')
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input class="form-control" name="tipe" type="text" value="{{$barang->tipe}}">
                                                </div>
                                                        <div class="col-md-6">
                                                                    <label for="">Jenis Barang</label>
                                                                    <input class="form-control" name="jenis" type="text" value="{{$barang->jenis}}">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input class="form-control" name="merk" type="text" value="{{$barang->merk}}">
                                                </div>
                                                        {{-- <div class="col-md-6">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        <input class="form-control" placeholder="Tipe Barang" name="tipe" type="text">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        <input class="form-control" placeholder="Jenis Barang" name="jenis" type="text">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        <input class="form-control" placeholder="Merk Barang" name="merk" type="text">
