...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Create Barang'])
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Create Barang</p>
                           
                        </div>
                    </div>
                    <div class="card-body">
                        <p class="text-uppercase text-sm">Create Barang</p>
                        <form method="post" action="{{route('store.barang')}}">
                        @csrf
                            <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Tipe</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Merk Barang</label>
