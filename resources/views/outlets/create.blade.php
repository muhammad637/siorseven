    ...
    <div class="row mt-4 mx-4">
        <div class="col-md-7">
            <div class="card text-capitalize">
                <div class="card-header fs-4 fw-bold text-uppercase ">{{ __('create') }}</div>
                <form method="POST" action="{{ route('outlets.store') }}" accept-charset="UTF-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="User" class="control-label">Pilih User</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="longitude"
                                        class="control-label">{{ __('longitude') }}</label>
                                    <input id="longitude" type="text"
                                        class="form-control{{ $errors->has('longitude') ? ' is-invalid' : '' }}"
                                        name="longitude" value="{{ old('longitude', request('longitude')) }}"
                                        required>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('outlets.index') }}" class="btn btn-secondary">{{ __('cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
